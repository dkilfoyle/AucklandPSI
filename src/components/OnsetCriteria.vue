<template lang="pug">
  div 
    ...
    q-card(v-if="minsSinceOnset < (4.5*60) && minsSinceOnset >= 0").fullwidth
      q-card-main.passing
    ...
    q-card(v-if="minsSinceOnset >= (4.5*60) && minsSinceOnset < (6*60)").fullwidth
      q-card-main.passing
    ...
    q-card(v-if="minsSinceOnset >= (6*60) && minsSinceOnset < (12*60)").fullwidth
      q-card-main.passing
